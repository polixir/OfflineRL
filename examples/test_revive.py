...
from batchrl.evaluation.d4rl import mujoco_eval_fn,mujoco_eval_env
...
def run_algo(**kwargs):
    ...
    algo_trainer.train(offlinebuffer,callback_fn=mujoco_eval_env(algo_config["task"], eval_episodes=10))
